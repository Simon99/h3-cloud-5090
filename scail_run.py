...
def build(vidname, refname, o):
    ...
    g = {
        ...
        "rz": {"class_type": "ResizeImageMaskNode",
               "inputs": {"input": ["fb", 0],
                          "resize_type": {"type": "scale dimensions",
                                          "scale dimensions": {"width": W, "height": H, "crop": "center"}},
                          "scale_method": "area"}},
        ...
        "sc": {"class_type": "WanSCAILToVideo",
               "inputs": {"positive": ["pos", 0], "negative": ["neg", 0], "vae": ["vae", 0],
                          ...
                          "video_frame_offset": 0, "previous_frame_count": 0,
