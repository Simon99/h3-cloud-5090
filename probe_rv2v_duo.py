...
W, H = 960, 544
PROMPT = ("The mannequin on the LEFT side of <Video 1> (the one who performs the flying kick and the backflip) "
          "must be replaced by the woman from <Picture 1> and <Picture 2> — "
          "a young Chinese woman in a mini-length deep-red gold-embroidered silk qipao, bare-handed. "
          "The mannequin on the RIGHT side of <Video 1> (the one who guards and does the low sweep) "
          "must be replaced by the panda from <Picture 3> and <Picture 4> — "
          "a towering realistic anthropomorphic giant panda in a white taekwondo dobok with a blue belt "
          "and red boxing gloves. Set the fight inside the boxing ring shown in <Picture 5>, cool white "
          "overhead spotlights, warm corner rim lights, hazy air. "
          "Keep the EXACT choreography, timing, spacing and camera framing of <Video 1>. "
          "Photorealistic live-action martial-arts film. EXACTLY ONE woman and EXACTLY ONE panda, never "
          "duplicated. No mannequins, no grey void. No on-screen text, no logos, no speech.")
